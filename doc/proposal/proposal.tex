...
\begin{document}
    ...
    \label{sec:plan}
        ...
        \subsection{Image dataset creation} {
            ...
            There is also the possibility of generating spheres procedurally, combing computer graphics and Physically Based Rendering \citep{pbr}, seen in Figure \ref{figure:pba}. This will provide an opportunity to thoroughly test and compare the detection methods on spheres with measurable and known characteristics. This will 
            
			\begin{figure}[H]            
				\centering
    	        \includegraphics[scale=0.3]{microcompare05.jpg}
	            \caption[Project Schedule] {
                	Computer generated spheres using Physically Based Rendering \citep{pbr}.
				}
