...
\begin{document}
	...
	\begin{abstract}
		...
		dataset will be created by the researchers and must include a broad 
    ...
    \label{sec:plan}
        ...
        \subsection{Image dataset creation} {
            ...
            of spheres and disks. There should be a balance of object sizes,
            patterns, colours and textures between the data and can include
            the use of a tennis, soccer, golf and cricket ball. To reduce the
            complexity of this project, the images will not contain moving
            balls, but they should be composed in different ways to capture a
            range of data.
            \todo{ make it clearer that `they' refers to the balls rather than the images }
            Images of balls that are primarily metallic or
            transparent will also not be included. To begin with, the images
	...
	\section{Project schedule} {
        ...
        \todo{Consider also listing/describing the major points of the plan here}
