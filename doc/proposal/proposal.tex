...
\begin{document}
	...
	\section{Project plan} {
        ...
        \subsection{Image dataset creation} {
        	...
        	tennis, soccer, golf and cricket ball. To reduce the complexity of this
        	project, the images will not contain moving balls, but they should be
        	composed in different ways to capture a range of data. To begin with,
        	the images should contain an individual ball or disk and then progress
        	to having both, or a combination of, within the same image. This will
        	test whether our methods of detection are able to identify multiple 
        	spheres correctly. Some images may feature:
