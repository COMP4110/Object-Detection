...
\begin{document}
    ...
    \label{sec:plan}
        ...
        \label{sec:dataset}
            ...
            Images of balls that are primarily metallic or transparent will also not
            be included in the initial dataset. To begin with, the images should 
            contain an individual ball or disk and then progress to having both, or
            a combination of, within the same image. This will test whether our 
            ...
            The dataset will include a good combination of features and environment
            configurations to test more complex cases. For example, two
            ...
            The positions and sizes of the spheres for each image will be
            specified using bounding boxes which are in the form of:
            ...
            These bounding boxes have been provided by ImageNet and are necessary 
            to train the classifiers using these cropped images.
    ...
    \label{sec:schedule}
        ...
        \todo{ Update the chart to indicate what has been accomplished, and what remains to be done. Add more detail, and plan until the final project due date. }
    ...
    \label{sec:results}
        ...
        A subset of the proposed image database has been obtained based on the ImageNet synset IDs \todo[inline]{sysnet IDs} for the positive images and \todo[inline]{sysnet IDs} as negative images.
        ...
        \begin{itemize}
            ...
            \item The set of negative examples is poor, in that the images it contains are far too dissimilar from spheres.
                  The use of different ImageNet sysnets, such as `n03032811 - Circle, round' into the set of negative samples may improve performance, and will be considered before the final report.
        \end{itemize}
